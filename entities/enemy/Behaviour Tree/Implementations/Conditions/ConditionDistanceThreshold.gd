...
func get_target_node(_actor: Node2D, _blackboard: BehaviourTreeBlackboard) -> Node2D:
	return null
	
## Returns the origin node. Will be the actor by default. May be overriden by children.
func get_origin_node(_actor: Node2D, _blackboard: BehaviourTreeBlackboard) -> Node2D:
	return _actor
